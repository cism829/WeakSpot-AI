# test.py
# pip install openai pillow opencv-python python-dotenv
import base64, time 
...
OUTPUT_DIR = r"C:\Users\trevo\OneDrive\Desktop\490\ocr_out"
MODEL = "gpt-4o-mini"   # "gpt-4o" if pages are especially messy
TEMPERATURE = 0
